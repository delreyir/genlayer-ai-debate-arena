...
export function Navbar() {
  ...
  const judgedDebates = debates?.filter((d) => d.status === "JUDGED").length || 0;
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">AI Debate Arena</span>
              </div>

              <div className="hidden md:flex items-center gap-6 text-sm">
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">Debates:</span>
                  <span className="text-foreground font-bold text-accent">{totalDebates}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">Judged:</span>
                  <span className="text-foreground font-bold text-accent">{judgedDebates}</span>
                </div>
              </div>
