...
import { usePlayerWins } from "@/lib/hooks/useDebates";
...
export function AccountPanel() {
  ...
  const { data: wins = 0 } = usePlayerWins(address);
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="brand-card border-2">
          <DialogHeader>
            ...
            <DialogDescription>
              Connect your MetaMask wallet to start debating
            </DialogDescription>
          </DialogHeader>
    ...
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <div className="flex items-center gap-4">
        <div className="brand-card px-4 py-2 flex items-center gap-3">
          ...
          <div className="flex items-center gap-1">
            <span className="text-sm font-semibold text-accent">{wins}</span>
      ...
      <DialogContent className="brand-card border-2">
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="brand-card p-4 space-y-2">
            <p className="text-sm text-muted-foreground">Debates Won</p>
